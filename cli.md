...
varies by platform:
<span class="info">`C:\Program Files (x86)\gapid\gapit.exe` on Windows, `/Applications/GAPID.app/Contents/MacOS/gapit` on Mac OS X, or `/opt/gapid/gapit` on linux.</span>
